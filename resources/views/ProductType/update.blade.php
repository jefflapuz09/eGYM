...
<div class="col-sm-6">
    <div class="box box-primary">
        ...
        <div class="box-body">
            <form action="{{ url('/ProductType/Update/id='.$post->id) }}" method="post">
                {{csrf_field()}}
                ...
                @if(count($post->typeBrand)!=0)
                    @foreach($post->typeBrand as $manyBrand)
                        <div id="brands">
                            @if($loop->index!=0)
                            ...
                            <div class="form-group" id="brand">
                                ...
                                <input type="text" name="brands[]" value="{{$manyBrand->Brand->name}}" class="form-control" >
                            </div>
                        </div>
                    @endforeach
                @endif

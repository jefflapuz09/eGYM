            ...
            <form action="{{ url('/Product/Store') }}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        ...
                        <select id="products" name="productId" class="form-control" required>
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            row = pList.row.add([
                ...
                '<strong><input class="price form-control text-right" name="price[]" value="0" id="price" type="text"></strong>',
                '<strong><input class="stack form-control no-border-input" id="stack" type="text" value="0" readonly></strong>',
...
$(document).on('keyup', '#price', function (){
    ...
    fprice = eval(price+"*"+qty);
    var row = rowFinder(this);
    $(this).closest('tr').find('#stack').val(fprice);
});
</script>
@stop

...
<div class="col-sm-6">
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">Update Unit of Measurement</h3>
            <div class="box-tools pull-right">
                <p class="pull-right"><b>Note</b>: Fields with <span style="color:red;">*</span> are needed to filled out.</p>
            </div>
        </div>
        <div class="box-body">
            <form action="{{ url('/UnitMeasurement/Update/id='.$post->id) }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" name="name" value="{{$post->name}}" class="form-control" id="">
                                </div>  
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                        ...
                        <textarea  id="" required class="form-control" rows="5" name="description">{{$post->description}}</textarea>
                        </div>
                        <div class="form-group">
